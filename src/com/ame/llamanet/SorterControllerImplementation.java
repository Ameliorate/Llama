 ...
 */
public class SorterControllerImplementation implements Runnable, SorterController {
	/**
	 * @param startThread Weather or not to start a new thread automatically for checking connections and opening new ones.
	 */
	public SorterControllerImplementation(boolean startThread) {
	...
	/**
	 * The thread used to check connections.
	 */
	public Thread connectionCheckThread;

	/**
	 * All of the current connections. Only mess with this if you need to.
	 */
	public HashSet<Connection> connections = new HashSet<>();
